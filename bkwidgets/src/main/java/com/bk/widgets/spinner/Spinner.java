...
package com.bk.widgets.spinner;
...
//       ImageView questionMarkImg = new ImageView(context);
//       questionMarkImg.setImageResource(R.drawable.question_mark_round_button);
//       TextView choosePromptText = new TextView(context);
//       choosePromptText.setText(r.getString(R.string.choosePrompt));
//       choosePromptText.setTextSize(18);
//       LinearLayout promptLayout = new LinearLayout(context);
//       promptLayout.setOrientation(LinearLayout.HORIZONTAL);
//       promptLayout.addView(questionMarkImg,new LinearLayout.LayoutParams(48, 48));
//       promptLayout.addView(choosePromptText,new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
//       promptLayout.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,48));
//       mNoneSelectedView = promptLayout;
    }
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleRes) {
            ...
            setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener()
            {
               ...
               public void onItemClick(android.widget.AdapterView<?> parent, View view, int position, long id)
               {
                 ...
                 if (mOnItemClickListener != null) {
                     Spinner.this.performItemClick(view, position, mAdapter.getItemId(position));
                 }
                 dismiss();
               }
            });
