...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
    ...
    private View mNoneSelectedView;
    ...
    public AbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        a.recycle();
        mNoneSelectedView = new View(context);
        mNoneSelectedView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,32));
    }
...
//            int position = mItemCount > 0 ? 0 : INVALID_POSITION;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       ...
       int paddingBottom = getPaddingBottom();
        ...
        {
           viewToMeasure = getNoneSelectedView();
        }

       if (viewToMeasure != null)
       {
           if (viewToMeasure.getLayoutParams() == null) {
               mBlockLayoutRequests = true;
              viewToMeasure.setLayoutParams(generateDefaultLayoutParams());
               mBlockLayoutRequests = false;
           }
           measureChild(viewToMeasure, widthMeasureSpec, heightMeasureSpec);

           preferredHeight = getChildHeight(viewToMeasure) + mSpinnerPadding.top + mSpinnerPadding.bottom;
           preferredWidth = getChildWidth(viewToMeasure) + mSpinnerPadding.left + mSpinnerPadding.right;
   ...
   protected View getNoneSelectedView()
   {

      return mNoneSelectedView;
   }
